...
**●▬▬▬▬▬ArtBot Commands▬▬▬▬▬●**
> ❯ \`${prefix}public \` :『**** اوامر الـعامـه ****』
> ❯ \`${prefix}admin \`  : 『**** اوامـر ادمـنـيه****』
...
> ❯ $title : لملىء خانة المعلومات الخاصة بك 
...
{}client.on('message', message => {
  ...
  if (message.content === prefix + "admin") {
      message.channel.send(`
**
> ❯  Administrative Orders | اوامر ادارية :
> ❯ $server : معلومات حول السيرفر
> ❯ $ban @user : حضر عضو من السيرفر
> ❯ $unban @user id : فك حضر عن عضو في السيرفر
> ❯ $clear : مسح الرسائل الموجوده في الروم بعدد
> ❯ $kick @user : طرد عضو من السيرفر
> ❯ $mute @user : اعضاء ميوت كتابي لعضو في السيرفر
> ❯ $unmute @user : فك الميوت عن عضو في السيرفر
> ❯ $warn @user : لتحذير شخص
> ❯ $autoreply [msg] | [reply] : أمر رد تلقائي من نفسك تحطو
> ❯ $delautoreply [msg nema] : أمر مسح رد تلقائي اسم الرسالي
> ❯ $autorole set {role nema}: اسم الرتبي إلى اوتو رول
> ❯ $setwelcomer [CHANNEL NAME] : لإختار روم الترحيب
**
`);
...
{}client.on('message', message => {
  ...
  if (message.content === prefix + "protection") {
      message.channel.send(`
**
> ❯  Protection | اوامر الحمايه :
> ❯ $antibots set on : تفعيل منع دخول بوتات 
> ❯ $antibots set off : الغاء تفعيل منع دخول بوتات
> ❯ $antispread set off : الغاء تفعيل خاصية منع نشر روابط
> ❯ $antispread set on : لتفعيل تفعيل خاصية منع نشر روابط
**
`);
...
client.on('message', message => {
  ...
  .bannable) return message.reply("✅**The rank of bot must be higher than the level of the person to be classified**");
...
client.on('message', message => {
  ...
  const kickembed = new Discord.RichEmbed()
    if (!message.guild.member(user)
  .kicknable) return message.channel.send(`✅ kicked ${user.username} from the server`)
  }
});
